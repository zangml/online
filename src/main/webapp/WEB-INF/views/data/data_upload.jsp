            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" action="/data/upload" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea  rows="5" name="problem" class="form-control" id="labDes" placeholder="请输入背景介绍"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="labDes" class="col-sm-2 control-label">数据描述</label>
                                <div class="col-sm-10">
                                    <textarea  rows="3" name="desc" class="form-control" id="labAim" placeholder="请输入数据描述"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
