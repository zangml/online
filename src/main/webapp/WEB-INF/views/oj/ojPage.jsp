...
<div class="categoryWithCarousel">
    ...
    <div class="homepageCategoryProducts">
        <div>
            <c:forEach items="${groupVos}" var="groupVo">
                <br>
                <div class="left-mark"></div>
                <span class="categoryTitle">${groupVo.type}</span>
                <div style="clear:both"></div>
                <c:forEach items="${groupVo.vos}" var="course">
                    <div class="productItem">
                        <a href="${course.url}"><img width="100px" src="${course.cover}"></a>
