...
import com.koala.learn.service.EsBlogService;
...
//			if(!esBlog.getAvatar().equals(user.getAvatar())){
...
//		}
		...
		if (!async && !isEmpty) {
			...
			List<TagVO> tags = esBlogService.listTop10Tags();
