...
//    public static String ROOT = "/data/learn/";
    public static String ROOT = "/Users/zangmenglei/PHM/";//根目录

    public static String WINDOW = "currentWindow";

    public static String UPDATE_CLASS_ROOT = "/usr/local/sk/"; //上传算法所在目录

    public static String UPDATE_CLASS_TEST_ROOT = "/Users/zangmenglei/"; //上传算法测试文件所在目录

    public static String IMAGE = "https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3972224591,2666750413&fm=173&s=84DB4D325D8A604F4E6125DA0000C0B2&w=600&h=475&img.JPEG";

    public static String IMAGE_FINISH = "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1522231621827&di=4f6231d529616d30d4ab7d6efb4a2c94&imgtype=0&src=http%3A%2F%2Fi1.bbswater.fd.zol-img.com.cn%2Ft_s480x480%2Fg5%2FM00%2F03%2F0C%2FChMkJ1lKEKaIAukFAAMbOVmHWTAAAdKmQPU0cEAAxtR277.png";

    public static String RELATIVE_CMD = "/usr/local/sk/relative.py";  //生成分类模型特征重要性分析的python文件
