...
import com.koala.learn.repository.EsBlogRepository;
...
public class EsBlogServiceImpl implements EsBlogService {
	...
	@Override
	public List<TagVO> listTop10Tags() {
		...
		SearchQuery searchQuery = new NativeSearchQueryBuilder()
				...
				.addAggregation(terms("tags").field("tags").order(Terms.Order.count(false)).size(10))
				.build();
		// when
...
//        Iterator<Bucket> modelBucketIt = modelTerms.getBuckets().iterator();
		...
		while (modelBucketIt.hasNext()) {
            ...
            list.add(new TagVO(actiontypeBucket.getKeyAsString(),
