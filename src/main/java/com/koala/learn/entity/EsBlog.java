...
//		this.username = userMapper.selectByPrimaryKey(blog.getUserId()).getUsername();
//		this.avatar = userMapper.selectByPrimaryKey(blog.getUserId()).getAvatar();
